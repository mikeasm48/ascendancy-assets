...
Генерируются **36 корабельных устройств**; орбитальные (`Orbital_*`, `Space_*`)
исключены и будут собраны отдельно; планетарные здания — существующие
city-set'ы `building_constructor.glb`.
